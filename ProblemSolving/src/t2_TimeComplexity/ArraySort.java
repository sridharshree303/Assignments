...
public class ArraySort {
	public static void main(String[] args) {
		System.out.println("SridharTeja");
	}
	
	//here the best and worst case time complexity is 1 and N
	//we have to consider the worst case time complexity for the finding the right solution
